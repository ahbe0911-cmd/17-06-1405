...
public class ForkSettingsActivity extends BaseFragment {
    ...
    private void fillSettings(ArrayList<UItem> items) {
        ...
        items.add(UItem.asSettingsCell(ID_CUSTOM_TITLE, LocaleController.getString(R.string.EditAdminRank), prefs().getString("forkCustomTitle", "Zaffran Gram")));
        items.add(UItem.asShadow(null));
    ...
    private void showCustomTitleDialog(View view) {
        final String defaultValue = "Zaffran Gram";
