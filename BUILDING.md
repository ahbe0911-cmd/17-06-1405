...
2. Don't forget to include the submodules when you clone:
      - `git clone --recursive https://github.com/ahbe0911-cmd/17-06-1405.git`
...
4. Telegram API credentials:
      - Zaffran Gram does not accept API credentials through `gradle.properties`,
        environment variables, GitHub Secrets, or any other build input.
      - Runtime onboarding for user-owned API ID/hash is implemented in the next development
        stage. Until then, the neutral placeholders intentionally prevent Telegram sign-in.
      - Obtain personal credentials from https://core.telegram.org/api/obtaining_api_id.
